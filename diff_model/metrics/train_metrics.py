...
import time
# import wandb
from diff_model.metrics.abstract_metrics import SumExceptBatchMetric, SumExceptBatchMSE, SumExceptBatchKL, CrossEntropyMetric, \
...
class TrainLossDiscrete(nn.Module):
    ...
    def log_epoch_metrics(self, current_epoch, start_epoch_time):
        ...
        return epoch_node_loss + self.lambda_train[0] * epoch_edge_loss + self.lambda_train[1] * epoch_y_loss
